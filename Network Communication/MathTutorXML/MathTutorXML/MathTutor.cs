...
namespace MathTutorXML
{
   public partial class MathTutor : Form
   {
         ...
         object sender, EventArgs e )
      {
         ...
         string xmlString = await service.GetStringAsync( new Uri(
            "http://localhost:56770/EquationGeneratorService.svc/" +
            "equation/" + operation + "/" + level ) );

         // parse response and get LeftHandSide and Result values
         XDocument xmlResponse = XDocument.Parse( xmlString );
