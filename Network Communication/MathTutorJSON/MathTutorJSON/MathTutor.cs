...
namespace MathTutorJSON
{
   public partial class MathTutor : Form
   {
      ...
      {
         // send request to EquationGeneratorService
         string jsonString = await service.GetStringAsync( new Uri(
            "http://localhost:57184/EquationGeneratorService.svc/" +
         ...
         currentEquation =
            ( Equation ) JSONSerializer.ReadObject( new MemoryStream(
